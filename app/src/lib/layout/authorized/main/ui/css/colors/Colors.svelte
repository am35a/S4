<section class="d-grid g-5">
    ...
    <div class="d-flex fw-wrap g-4">
        <div class="d-grid justify-item--center p-4 bgc-positive br-lg fx" style="--fxg: 1; --fxb: 0;">
        ...
        <div class="d-grid g-3 justify-item--center p-4 br-lg fx bgc-negative" style="--fxb: 100%;">
        ...
        <div class="d-grid g-3 justify-item--center p-4 br-lg fx bgc-positive" style="--fxb: 100%;">
