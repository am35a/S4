<section class="display--grid gap--lg">
    ...
    <div class="display--flex flex-wrap--wrap gap--md">
        <div class="display--grid justify-item--center padding--md background-color--positive border-radius--lg flex" style="--flex-grow: 1; --flex-basis: 0;">
        ...
        <div class="display--grid gap--sm justify-item--center padding--md border-radius--lg flex background-color--negative" style="--flex-basis: 100%;">
        ...
        <div class="display--grid gap--sm justify-item--center padding--md border-radius--lg flex background-color--positive" style="--flex-basis: 100%;">
