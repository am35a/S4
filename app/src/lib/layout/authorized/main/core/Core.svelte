...
<div class="display--inline-block">
    ...
    <div class="display--inline-grid grid-template-columns g-2" style="--grid-template-columns: auto 1fr">
...
<div class="display--inline-block">
    ...
    <div>
        <h3>Device type</h3>
        <div class="display--grid grid-template-columns--3 g-2">
            <div class="fw-600">Breakpoint</div>
            <div class="fw-600">Class prefix</div>
            <div class="fw-600">
                Pattern
                <div class="display--inline-grid grid-template-columns g-1 fs-xxs" style="--grid-template-columns: auto auto">
