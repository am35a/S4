<script lang="ts">
    ...
    let overflowPropertyArr: string[] = [ 'auto', 'hidden', 'visible', 'scroll' ]
    let overflowProperty: string = overflowPropertyArr[0]
</script>
<section>
    ...
    <div class="display--grid g-3 mb-4 p-3 background-color--positive border-radius--md">
        ...
        <div class="o-{overflowProperty} mx-auto background-color--negative-10 p-2" style="width: 24em; height: 16em;">
