<section class="d-grid g-5">
    ...
    <div class="d-grid g-4">
        <div class="d-grid g-3 bgc-positive p-4 br-lg bs-xxxl">
            <div>
                <p>
            ...
            <div class="d-grid bgc-positive p-4 br-lg bs-xxl">
                <div class="d-grid bgc-positive p-4 br-lg bs-xl">
                    <div class="d-grid bgc-positive p-4 br-lg bs-lg">
